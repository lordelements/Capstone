							...
							<div class="form-box search-properties">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-6 col-md-12">
										<div class="form-group">
											<div class="select--box">
												<input type="text" name="address" class="form-control" id="select-address" placeholder="Purok/Zone" required>
												<!-- <i class="fa fa-angle-down"></i>
												<select name="civilstatus" id="select-type">
		...
		<div class="container">
			...
			$sql = "SELECT * FROM officials";
						...
						?>
							   ...
							   <td><?php echo  $row['termyears'] ?></td>
							   <td><?php echo  $row['yearstarted'] ?></td>
							  
								
                                <!-- echo "<td>" $offcialscountno++" </td> ";
							...
							<?php
                                ...
                                echo "<td>" . $stat . "</td> ";
                                echo "<td><a target='_blank' class='btn btn-primary' style='width:100%;border:1px solid black;color:black' href='".$row['idcard']."'><i class='fa fa-eye'></i></a></td> ";
                                // echo "<td><a class='btn btn-danger' style='width:49%;border:1px solid black;color:black' 
								// href='delOfficials.php?delOff_id=" . $row['officialid'] . "'>Delete</a></td> ";
								...
								<a class='btn btn-danger' style='width:49%;border:1px solid black;color:black' 
								href='delOfficials.php?delOff_id=" . $row['officialid'] . "'><i class='fa fa-trash'></i></a>";
