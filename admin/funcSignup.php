...
if($pass == $conpass){
	if($res && mysqli_num_rows($res)>0)
	{
		...
		$sql2 = "INSERT INTO accounts(fname,mname,lname,email,password,idcard,contactnumber,address,position,acctype,status) VALUES ('$fname','$mname','$lname','$email','$pass','$idcard','$contact','$address','$position',$acctype,'1')";
		...
		myAlert1("Registered Successfully! You can now login.", "users_account.php");
	}
}
else {
	function myAlert1($msg, $url){
	...
	myAlert1("Password and confirm password does not match!", "users_account.php");
}
