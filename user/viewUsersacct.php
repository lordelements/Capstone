                ...
                <?php 
                    ...
                    <div class="form-box search-properties">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="position" value="'.$row['position'].'"  id="position" style="text-transform:capitalize;width: 100%;display: inline;" placeholder="Position" required="required">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" pattern="[0-9]{11}" class="form-control" name="contactnumber" value="'.$row['contactnumber'].'" id="contact" style="text-transform:capitalize;width: 50%;display: inline" placeholder="Contact Number" required="required">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="password" value="'.$row['password'].'" style="width: 49.5%;display: inline;" id="register-password" placeholder="Password">
